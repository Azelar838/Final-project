async function getProduct() {
    const respP = fetch("https://fakestoreapi.com/products")
        .then(res => res.json())
    return respP
}
...
async function main() {
    ...
    let container = document.getElementById("workdiv");
    ...
    for (let i = 0; i < 12; i++) {
        let product = products[i];
            ...
            productimg2.src = "https://res.cloudinary.com/dtrvdcebd/image/upload/v1708266044/Clothy/giywnwhsomoybyi9vgxj.png"; 
            productimg3.src ="https://res.cloudinary.com/dtrvdcebd/image/upload/v1708266043/Clothy/q1pbhfwzuy1u8xqq6cbd.png";
